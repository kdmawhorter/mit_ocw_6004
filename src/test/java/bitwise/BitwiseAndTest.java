...
public class BitwiseAndTest extends BitwiseTest {
    ...
    void bitwiseAndTest() {
        ...
        and1Bit.evaluate();
        assertArrayEquals(mapTest(TEST_1_0), and1Bit.readOutputs(), "1 Bit Bitwise And 00 Test");

        and1Bit.assignInputs(TEST_2_01);
        and1Bit.evaluate();
        assertArrayEquals(mapTest(TEST_1_0), and1Bit.readOutputs(), "1 Bit Bitwise And 01 Test");

        and1Bit.assignInputs(TEST_2_10);
        and1Bit.evaluate();
        assertArrayEquals(mapTest(TEST_1_0), and1Bit.readOutputs(), "1 Bit Bitwise And 10 Test");

        and1Bit.assignInputs(TEST_2_11);
        and1Bit.evaluate();
        assertArrayEquals(mapTest(TEST_1_1), and1Bit.readOutputs(), "1 Bit Bitwise And 11 Test");

        // 2 Bit Bitwise And Test
        and2Bit.assignInputs(TEST_4_0000);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), and2Bit.readOutputs(), "2 Bit Bitwise And 0000 Test");

        and2Bit.assignInputs(TEST_4_0001);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), and2Bit.readOutputs(), "2 Bit Bitwise And 0001 Test");

        and2Bit.assignInputs(TEST_4_0010);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), and2Bit.readOutputs(), "2 Bit Bitwise And 0010 Test");

        and2Bit.assignInputs(TEST_4_0011);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), and2Bit.readOutputs(), "2 Bit Bitwise And 0011 Test");

        and2Bit.assignInputs(TEST_4_0100);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), and2Bit.readOutputs(), "2 Bit Bitwise And 0100 Test");

        and2Bit.assignInputs(TEST_4_0101);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_01), and2Bit.readOutputs(), "2 Bit Bitwise And 0101 Test");

        and2Bit.assignInputs(TEST_4_0110);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), and2Bit.readOutputs(), "2 Bit Bitwise And 0110 Test");

        and2Bit.assignInputs(TEST_4_0111);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_01), and2Bit.readOutputs(), "2 Bit Bitwise And 0111 Test");

        and2Bit.assignInputs(TEST_4_1000);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), and2Bit.readOutputs(), "2 Bit Bitwise And 1000 Test");

        and2Bit.assignInputs(TEST_4_1001);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), and2Bit.readOutputs(), "2 Bit Bitwise And 1001 Test");

        and2Bit.assignInputs(TEST_4_1010);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_10), and2Bit.readOutputs(), "2 Bit Bitwise And 1010 Test");

        and2Bit.assignInputs(TEST_4_1011);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_10), and2Bit.readOutputs(), "2 Bit Bitwise And 1011 Test");

        and2Bit.assignInputs(TEST_4_1100);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), and2Bit.readOutputs(), "2 Bit Bitwise And 1100 Test");

        and2Bit.assignInputs(TEST_4_1101);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_01), and2Bit.readOutputs(), "2 Bit Bitwise And 1101 Test");

        and2Bit.assignInputs(TEST_4_1110);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_10), and2Bit.readOutputs(), "2 Bit Bitwise And 1110 Test");

        and2Bit.assignInputs(TEST_4_1111);
        and2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), and2Bit.readOutputs(), "2 Bit Bitwise And 1111 Test");
