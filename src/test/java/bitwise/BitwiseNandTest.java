...
public class BitwiseNandTest extends BitwiseTest {
    ...
    void bitwiseNandTest() {
        ...
        nand1Bit.evaluate();
        assertArrayEquals(mapTest(TEST_1_1), nand1Bit.readOutputs(), "1 Bit Bitwise Nand 00 Test");

        nand1Bit.assignInputs(TEST_2_01);
        nand1Bit.evaluate();
        assertArrayEquals(mapTest(TEST_1_1), nand1Bit.readOutputs(), "1 Bit Bitwise Nand 01 Test");

        nand1Bit.assignInputs(TEST_2_10);
        nand1Bit.evaluate();
        assertArrayEquals(mapTest(TEST_1_1), nand1Bit.readOutputs(), "1 Bit Bitwise Nand 10 Test");

        nand1Bit.assignInputs(TEST_2_11);
        nand1Bit.evaluate();
        assertArrayEquals(mapTest(TEST_1_0), nand1Bit.readOutputs(), "1 Bit Bitwise Nand 11 Test");

        // 2 Bit Nand Test
        nand2Bit.assignInputs(TEST_4_0000);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 0000 Test");

        nand2Bit.assignInputs(TEST_4_0001);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 0001 Test");

        nand2Bit.assignInputs(TEST_4_0010);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 0010 Test");

        nand2Bit.assignInputs(TEST_4_0011);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 0011 Test");

        nand2Bit.assignInputs(TEST_4_0100);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 0100 Test");

        nand2Bit.assignInputs(TEST_4_0101);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_10), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 0101 Test");

        nand2Bit.assignInputs(TEST_4_0110);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 0110 Test");

        nand2Bit.assignInputs(TEST_4_0111);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_10), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 0111 Test");

        nand2Bit.assignInputs(TEST_4_1000);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 1000 Test");

        nand2Bit.assignInputs(TEST_4_1001);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 1001 Test");

        nand2Bit.assignInputs(TEST_4_1010);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_01), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 1010 Test");

        nand2Bit.assignInputs(TEST_4_1011);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_01), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 1011 Test");

        nand2Bit.assignInputs(TEST_4_1100);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_11), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 1100 Test");

        nand2Bit.assignInputs(TEST_4_1101);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_10), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 1101 Test");

        nand2Bit.assignInputs(TEST_4_1110);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_01), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 1110 Test");

        nand2Bit.assignInputs(TEST_4_1111);
        nand2Bit.evaluate();
        assertArrayEquals(mapTest(TEST_2_00), nand2Bit.readOutputs(), "2 Bit Bitwise Nand 1111 Test");
